...
model Simplified "Simplified transformer harmonic model"
  ...
  */
  ...
  HPF.SinglePhase.Components.Impedance z(start_v_im = cat(1, {nomV_prim * sin(phi_prim)}, {0.0 for i in 1:systemDef.numHrm - 1}), start_v_re = cat(1, {nomV_prim * cos(phi_prim)}, {0.0 for i in 1:systemDef.numHrm - 1}), z = 1e-10 + Xm * j)  annotation (
...
equation
  ...
  connect(R.pin_p, z.pin_p) annotation (
    Line(points = {{-32, 10}, {-6, 10}}, color = {92, 53, 102}));
  connect(z.pin_p, idealTransformer.pinP_Prim) annotation (
    Line(points = {{-6, 10}, {-20, 10}, {-20, 30}, {16, 30}, {16, 8}}, color = {92, 53, 102}));
  connect(z.pin_n, R.pin_n) annotation (
    Line(points = {{-6, -10}, {-32, -10}}, color = {117, 80, 123}));
...
<p><img src=\"modelica://HPF/Resources/images/Transformers/t_model.png\"/></p>
</html>"));
end Simplified;
