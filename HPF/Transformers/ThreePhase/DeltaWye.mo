...
equation
  ...
  connect(pinSec_C.pinSec_C, T3.pinP_sec) annotation(
    Line(points = {{100, -38}, {60, -38}, {60, -100}, {12, -100}, {12, -100}}));
  connect(ground.pin, pinSec_N.pinSec_N) annotation(
    Line(points = {{28, -146}, {28, -146}, {28, -120}, {100, -120}, {100, -120}}));
  annotation (
