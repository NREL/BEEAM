...
<p>Simple 3-phase, grid-forming DC/AC converter (inverter) model. Output is voltage-controlled, with no voltage harmonics.</p><p></p><h3>Harmonics Model</h3><p></p><p>This device operates with zero harmonic voltage distortion and losslessly sinks all current harmonics.</p><h3>Efficiency Model</h3><p>This device uses a two-stage efficiency model:</p>
<p><img src=\"modelica://HPF/Resources/images/PowerConverters/eq_2stagelossmodel_inverter.png\"></p><p><b style=\"background-color: rgb(255, 255, 0);\">TO DO: Update Graphic and description below.</b></p>
