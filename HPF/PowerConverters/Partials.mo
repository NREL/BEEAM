...
package Partials
  ...
  annotation(
      Icon(graphics = {Polygon(origin = {-2, -73}, pattern = LinePattern.Dash, points = {{-14, 11}, {-54, -23}, {38, -23}, {58, 11}, {-14, 11}}), Line(origin = {3.68493, -72.4315}, points = {{-20, -23}, {10, 11}}, pattern = LinePattern.Dash), Line(origin = {7.69173, -71.3014}, points = {{38, -7}, {-42, -7}}, pattern = LinePattern.Dash), Line(origin = {24.5548, -76.4383}, points = {{-20, -19}, {-6, -1}}, arrow = {Arrow.Filled, Arrow.Filled}), Ellipse(origin = {12, -86}, fillPattern = FillPattern.Solid, extent = {{-2, 2}, {2, -2}}, endAngle = 360), Line(origin = {27.1233, -74.8287}, points = {{-34, -11}, {14, -11}}, arrow = {Arrow.Filled, Arrow.Filled})}),
      Documentation(info = "<html><head></head><body>Converter model using 2D interpolation</body></html>"));end HarmonicModel_Interp;
  ...
  annotation(
      Icon(graphics = {Text(origin = {3, -79}, extent = {{-81, 13}, {81, -13}}, textString = "I = f(h, P, param)", textStyle = {TextStyle.Italic})}));end HarmonicModel_Parameterized;
  annotation(
