...
model Demo
  ...
  Modelica.Blocks.Interfaces.RealInput u
    annotation (Placement(transformation(extent={{76,2},{50,28}})));
  Modelica.Blocks.Interfaces.RealOutput y
    annotation (Placement(transformation(extent={{14,70},{40,96}})));
equation
  ...
  connect(led_driver.PLoss, y)
    annotation (Line(points={{-8,31},{-8,83},{27,83}}, color={0,0,127}));
  connect(u, load.u) annotation (Line(points={{63,15},{48.5,15},{48.5,16.2},{
          33.8,16.2}}, color={0,0,127}));
  annotation (
    uses(Modelica(version = "3.2.2")),
    experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-06, Interval = 0.002),
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian,newInst -d=initialization ",
    __OpenModelica_simulationFlags(lv = "LOG_STATS", outputFormat = "mat", s = "dassl"),
  Diagram(graphics={  Rectangle(origin = {-6, 26}, pattern = LinePattern.DashDot, extent = {{-20, 16}, {22, -30}}), Text(origin = {-4, 42}, extent = {{-20, 8}, {10, 2}}, textString = "zone 1"), Text(origin = {-16, 16}, lineColor = {28, 108, 200}, extent = {{-68, 90}, {-6, 82}}, textString = "Setup demonstrating HPF.", fontSize = 11, textStyle = {TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold},
            horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left)}, coordinateSystem(extent = {{-150, -150}, {150, 150}}, initialScale = 0.1)),
