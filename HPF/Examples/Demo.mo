...
model Demo
  ...
  HPF.ExternalInterface.Zone zone_1 annotation(
    Placement(visible = true, transformation(extent = {{-20, 62}, {0, 82}}, rotation = 0)));
...
equation
  ...
  connect(zone_1.u, led_driver.PLoss) annotation(
    Line(points = {{-10, 64}, {-10, 64}, {-10, 40}, {-8, 40}, {-8, 32}, {-8, 32}}, color = {0, 0, 127}));
  ...
  connect(load.u, const.y) annotation(
    Line(points = {{32, 16}, {44, 16}, {44, 16}, {44, 16}}, color = {0, 0, 127}));
  annotation(
    uses(Modelica(version = "3.2.2")),
    experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-06, Interval = 0.002),
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian,newInst -d=initialization ",
    __OpenModelica_simulationFlags(lv = "LOG_STATS", outputFormat = "mat", s = "dassl"),
  Diagram(graphics = {Rectangle(origin = {-6, 26}, pattern = LinePattern.DashDot, extent = {{-20, 16}, {22, -30}}), Text(origin = {-4, 42}, extent = {{-20, 8}, {10, 2}}, textString = "zone 1"), Text(origin = {-16, 16}, lineColor = {28, 108, 200}, extent = {{-68, 90}, {-6, 82}}, textString = "Setup demonstrating HPF.", fontSize = 11, textStyle = {TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold}, horizontalAlignment = TextAlignment.Left)}, coordinateSystem(extent = {{-150, -150}, {150, 150}}, initialScale = 0.1)),
