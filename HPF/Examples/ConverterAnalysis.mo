...
equation
  ...
  connect(vSrc.pin_n, ground.pin) annotation (
    Line(points={{-116,38},{-116,38},{-116,37.25},{-116,37.25}},    color = {117, 80, 123}));
  ...
  connect(Z12.pin_n, ground2.pin) annotation (
    Line(points={{10,72},{26,72},{26,79.25},{26,79.25}},    color = {117, 80, 123}));
  connect(rect1.hPin_N, ground3.pin) annotation (
    Line(points={{-22,32},{-34,32},{-34,37.25}},     color = {117, 80, 123}));
