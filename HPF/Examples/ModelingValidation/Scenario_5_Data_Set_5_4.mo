...
model Scenario_5_Data_Set_5_4
  ...
  DC.DC_Load     Latop_5(pwr=71.019)  annotation (
  ...
  DC.DC_Load LumpedDCLoads(pwr=667.606) annotation (Placement(visible=true,
        transformation(
        origin={14,-32},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  ...
  SinglePhase.Components.Terminate terminate1
    annotation (Placement(transformation(extent={{-84,-6},{-70,8}})));
...
equation
  ...
  connect(deltaWye.pinSec_B, terminate.hPin_P)
    annotation (Line(points={{-86,8},{-79,8}}, color={92,53,102}));
  connect(deltaWye.pinSec_C, terminate1.hPin_P) annotation (Line(points={{-86,0},
          {-84,0},{-84,0},{-79,0}}, color={92,53,102}));
  annotation (
