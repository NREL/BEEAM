...
model Scenario_5_Data_Set_5_4
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl NextekHub( V_Rect = 25, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Nextek_120V_1600W_3D.mat", nomP = 1000) annotation(
  ...
  SinglePhase.Components.Terminate terminate annotation(
    Placement(transformation(extent = {{-84, 2}, {-70, 16}})));
  SinglePhase.Components.Terminate terminate1 annotation(
    Placement(transformation(extent = {{-84, -6}, {-70, 8}})));
...
equation
  ...
  connect(deltaWye.pinSec_B, terminate.hPin_P) annotation(
    Line(points = {{-86, 8}, {-79, 8}}, color = {92, 53, 102}));
  connect(deltaWye.pinSec_C, terminate1.hPin_P) annotation(
    Line(points = {{-86, 0}, {-84, 0}, {-84, 0}, {-79, 0}}, color = {92, 53, 102}));
  connect(ground1.p, LaptopCharger_6.n1) annotation(
    Line(points = {{26, -54}, {26, -54}, {26, -4}, {34, -4}, {34, -4}}, color = {0, 0, 255}));
  annotation(
