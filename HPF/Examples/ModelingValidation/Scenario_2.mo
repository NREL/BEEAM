...
model Scenario_2
  ...
  HPF.Transformers.ThreePhase.DeltaWye deltaWye(Rc = 3.5366e+03, Rp = 2.7672, Rs = 0.2576,VPrimRated = 480, VSecRated = 208, Xm = 711.1091, Xp = 1.1006, Xs = 0.5003,fEC = 0.067, fOSL = 0.033, fW = 0.9) annotation (
    Placement(visible = true, transformation(origin={-98, 0},    extent = {{-16, -16}, {16, 16}}, rotation = 0)));
...
equation
  connect(voltageSource.pinN, ground.pin) annotation(
    Line(points = {{-180, -10}, {-180, -18}}, color = {117, 80, 123}));
  ...
  connect(voltageSource.pinP_phB, iMsr_prim_PhA.pin_p) annotation(
    Line(points = {{-170, 8}, {-167, 8}, {-167, 10}, {-164, 10}}, color = {92, 53, 102}));
  connect(iMsr_prim_PhA.pin_n, deltaWye.pinPrim_A) annotation(
    Line(points = {{-144, 10}, {-108, 10}}, color = {117, 80, 123}));
  ...
  connect(deltaWye.pinSec_N, ground2.pin) annotation(
    Line(points = {{-88, -12}, {-80, -12}, {-80, -18}}, color = {117, 80, 123}));
  ...
  connect(LED_Driver_1.hPin_P, deltaWye.pinSec_A) annotation(
    Line(points = {{-4, 94}, {-44, 94}, {-44, 12}, {-88, 12}}, color = {92, 53, 102}));
  connect(Power_Supply_1.hPin_P, deltaWye.pinSec_A) annotation(
    Line(points = {{-6, 50}, {-44, 50}, {-44, 12}, {-88, 12}}, color = {92, 53, 102}));
  connect(Laptop_charger_3.hPin_P, deltaWye.pinSec_A) annotation(
    Line(points = {{-4, 2}, {-44, 2}, {-44, 12}, {-88, 12}}, color = {92, 53, 102}));
  connect(deltaWye.pinSec_B, LED_Driver_2.hPin_P) annotation(
    Line(points = {{-88, 4}, {-54, 4}, {-54, -46}, {82, -46}, {82, 20}, {122, 20}}, color = {92, 53, 102}));
  ...
  connect(iMsr_prim_PhC.pin_n, deltaWye.pinPrim_C) annotation(
    Line(points = {{-138, -10}, {-108, -10}}, color = {117, 80, 123}));
  connect(iMsr_prim_PhB.pin_n, deltaWye.pinPrim_B) annotation(
    Line(points = {{-116, 0}, {-108, 0}}, color = {117, 80, 123}));
  ...
  connect(deltaWye.pinSec_C, LED_Driver_3.hPin_P) annotation(
    Line(points = {{-88, -4}, {-64, -4}, {-64, -58}, {-2, -58}}, color = {92, 53, 102}));
  connect(voltageSource.pinP_phA, iMsr_prim_PhB.pin_p) annotation(
    Line(points = {{-170, 0}, {-136, 0}}, color = {92, 53, 102}));
  connect(voltageSource.pinP_phC, iMsr_prim_PhC.pin_p) annotation(
    Line(points = {{-170, -8}, {-159, -8}, {-159, -10}, {-158, -10}}, color = {92, 53, 102}));
