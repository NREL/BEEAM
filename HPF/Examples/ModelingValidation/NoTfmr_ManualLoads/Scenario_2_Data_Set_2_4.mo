within HPF.Examples.ModelingValidation.NoTfmr_ManualLoads;
...
model Scenario_2_Data_Set_2_4
  ...
  HPF.Sources.ThreePhase.VotlageSource voltageSource(vArg_phA = {6.2746, 0.98224, 5.9594, 2.9177, 0.34672, 4.9702, 1.3017, 4.9878, 2.2162, 2.0372}, vArg_phB = {2.0856, 0.72153, 2.1146, 3.4627, 4.052, 3.5454, 3.5171, 3.9976, 4.761, 4.455}, vArg_phC = {4.1804, 1.1667, 0.27168, 0.86058, 5.1906, 2.7508, 3.5819, 1.8474, 4.0803, 2.5459}, vMag_phA = {119.5941, 0.61079, 0.71444, 0.66802, 0.65663, 0.34336, 0.29531, 0.05003, 0.070744, 0.01079}, vMag_phB = {119.9794, 2.8089, 2.2149, 1.1386, 0.59509, 0.33249, 0.29805, 0.17755, 0.074639, 0.064706}, vMag_phC = {122.717, 0.88698, 0.67201, 0.41019, 0.36005, 0.27539, 0.041419, 0.058456, 0.054383, 0.041341}) annotation(
...
equation
  ...
  annotation(
    Diagram(coordinateSystem(extent = {{-230, -230}, {230, 230}}, initialScale = 0.1), graphics = {Text(origin = {-10, -32}, lineColor = {28, 108, 200}, extent = {{-182, 192}, {146, 164}}, textString = "Scenario 2 | Data Set 2.4
