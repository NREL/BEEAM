...
model Scenario_2_Data_Set_2_4
  ...
  SinglePhase.Components.Ground     ground2 annotation (
    Placement(visible = true, transformation(origin={-82,-34},     extent={{-10,-10},
            {10,10}},                                                                               rotation = 0)));
...
equation
  ...
  connect(deltaWye.pinSec_N,ground2. pin) annotation (
    Line(points={{-84,-8},{-82,-8},{-82,-22.75}},       color = {117, 80, 123}));
  connect(voltageSource.pinP_phA, deltaWye.pinPrim_A)
    annotation (Line(points={{-135.5,14},{-104,14}}, color={92,53,102}));
  connect(voltageSource.pinP_phB, deltaWye.pinPrim_B)
    annotation (Line(points={{-135.5,4},{-104,4}}, color={92,53,102}));
  connect(voltageSource.pinP_phC, deltaWye.pinPrim_C)
    annotation (Line(points={{-135.5,-6},{-104,-6}}, color={92,53,102}));
  ...
  connect(Power_Supply_3.pin_p,dC_Load. p) annotation (
    Line(points={{70,-86},{80,-86},{80,-88},{90,-88}},
                                             color = {0, 0, 255}));
  ...
  connect(deltaWye.pinSec_A, LED_Driver_1.hPin_P) annotation (Line(points={{-84,
          16},{8,16},{8,112},{52,112}}, color={92,53,102}));
  connect(Power_Supply_1.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points={{
          50,68},{8,68},{8,112},{52,112}}, color={92,53,102}));
  connect(Laptop_Charger_3.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points=
         {{52,20},{8,20},{8,112},{52,112}}, color={92,53,102}));
  connect(deltaWye.pinSec_B, LED_Driver_2.hPin_P) annotation (Line(points={{-84,
          8},{0,8},{0,-18},{122,-18},{122,38},{154,38}}, color={92,53,102}));
  connect(Power_Supply_2.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points={{
          154,-8},{122,-8},{122,38},{154,38}}, color={92,53,102}));
  connect(Laptop_Charger_4.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points=
         {{152,-54},{122,-54},{122,38},{154,38}}, color={92,53,102}));
  connect(deltaWye.pinSec_C, LED_Driver_3.hPin_P) annotation (Line(points={{-84,
          0},{-24,0},{-24,-40},{54,-40}}, color={92,53,102}));
  connect(Power_Supply_3.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points={{50,-86},
          {-24,-86},{-24,-40},{54,-40}},         color={92,53,102}));
  connect(Laptop_Charger_5.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points=
         {{46,-136},{-24,-136},{-24,-40},{54,-40}}, color={92,53,102}));
  annotation (
    Diagram(coordinateSystem(extent={{-280,-220},{260,240}}), graphics={                           Text(origin={
              -62,-28},                                                                                                     lineColor = {28, 108, 200}, extent = {{-182, 192}, {310, 152}}, textString = "Scenario 2 | Data Set 2.4 (1300W)
