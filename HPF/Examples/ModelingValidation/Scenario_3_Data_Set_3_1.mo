...
equation
  ...
  annotation (
    Diagram(coordinateSystem(extent = {{-280, -220}, {260, 240}}), graphics = {Text(origin = {6.08, 34}, lineColor = {28, 108, 200}, extent = {{-176.08, 144}, {299.92, 114}}, textString = "Scenario 3 | Data Set 3.1
No Load
No Load
