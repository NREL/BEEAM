...
equation
  ...
  connect(LED_Driver_1.hPin_N, ground6.pin) annotation (
    Line(points={{72,46},{54,46},{54,-10.75}},     color = {117, 80, 123}));
  connect(LED_Driver_2.hPin_N, ground17.pin) annotation (
    Line(points={{172,-36},{152,-36},{152,-84.75}},     color = {117, 80, 123}));
  connect(LED_Driver_3.hPin_N, ground19.pin) annotation (
    Line(points={{74,-118},{48,-118},{48,-164.75}},     color = {117, 80, 123}));
  ...
  connect(Heater_2_A.pin_n, ground6.pin) annotation (
    Line(points={{78,74},{54,74},{54,-10.75},{54,-10.75}},    color = {117, 80, 123}));
  connect(Heater_1_A.pin_n, ground6.pin) annotation (
    Line(points={{78,104},{54,104},{54,-10.75},{54,-10.75}},    color = {117, 80, 123}));
  ...
  connect(Heater_2_B.pin_n, ground17.pin) annotation (
    Line(points={{186,-2},{152,-2},{152,-84.75}},     color = {117, 80, 123}));
