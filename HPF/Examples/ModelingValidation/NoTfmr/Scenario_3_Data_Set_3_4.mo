...
equation
  ...
  connect(Heater_2_A.pin_n, ground6.pin) annotation (
    Line(points={{86,28},{54,28},{54,-10.75},{54,-10.75}},    color = {117, 80, 123}));
  ...
  connect(Heater_2_C.pin_n, ground19.pin) annotation (
    Line(points={{76,-128},{48,-128},{48,-164.75},{48,-164.75}},    color = {117, 80, 123}));
  ...
  connect(Heater_2_B.pin_n, ground17.pin) annotation (
    Line(points={{184,-44},{152,-44},{152,-84.75},{152,-84.75}},    color = {117, 80, 123}));
