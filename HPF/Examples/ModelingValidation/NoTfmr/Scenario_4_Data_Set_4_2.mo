...
equation
  ...
  connect(ground19.pin, Laptop_Charger_5.hPin_N) annotation (
    Line(points={{46,-186.75},{46,-124},{62,-124}},     color = {92, 53, 102}));
  ...
  connect(LED_Driver_1.hPin_N, ground6.pin) annotation (
    Line(points={{70,54},{54,54},{54,-10.75}},     color = {117, 80, 123}));
  connect(LED_Driver_2.hPin_N, ground17.pin) annotation (
    Line(points={{170,-36},{152,-36},{152,-84.75}},     color = {117, 80, 123}));
  connect(LED_Driver_3.hPin_N, ground19.pin) annotation (
    Line(points={{70,-80},{46,-80},{46,-186.75}},     color = {117, 80, 123}));
  ...
  connect(Heater_2_A.pin_n, ground6.pin) annotation (
    Line(points={{88,106},{54,106},{54,-10.75},{54,-10.75}},    color = {117, 80, 123}));
  connect(Heater_1_A.pin_n, ground6.pin) annotation (
    Line(points={{88,78},{54,78},{54,-10.75},{54,-10.75}},    color = {117, 80, 123}));
  connect(Heater_2_C.pin_n, ground19.pin) annotation (
    Line(points={{76,-190},{46,-190},{46,-186.75},{46,-186.75}},    color = {117, 80, 123}));
  connect(Heater_1_C.pin_n, ground19.pin) annotation (
    Line(points={{76,-162},{46,-162},{46,-186.75},{46,-186.75}},    color = {117, 80, 123}));
