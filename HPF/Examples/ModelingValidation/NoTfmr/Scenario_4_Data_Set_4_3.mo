...
equation
  ...
  connect(ground19.pin, Laptop_Charger_5.hPin_N) annotation (
    Line(points={{44,-202.75},{44,-122},{60,-122}},     color = {92, 53, 102}));
  ...
  connect(LED_Driver_2.hPin_N, ground17.pin) annotation (
    Line(points={{172,-32},{152,-32},{152,-84.75}},     color = {117, 80, 123}));
  connect(LED_Driver_3.hPin_N, ground19.pin) annotation (
    Line(points={{72,-70},{44,-70},{44,-202.75}},     color = {117, 80, 123}));
  ...
  connect(Heater_1_A.pin_n, ground6.pin) annotation (
    Line(points={{82,84},{54,84},{54,-10.75},{54,-10.75}},    color = {117, 80, 123}));
  ...
  connect(Heater_2_B.pin_n, ground17.pin) annotation (
    Line(points={{186,-2},{152,-2},{152,-84.75},{152,-84.75}},    color = {117, 80, 123}));
  ...
  connect(Heater_2_C.pin_n, ground19.pin) annotation (
    Line(points={{76,-202},{44,-202},{44,-202.75},{44,-202.75}},    color = {117, 80, 123}));
  connect(Heater_1_C.pin_n, ground19.pin) annotation (
    Line(points={{76,-174},{44,-174},{44,-202.75},{44,-202.75}},    color = {117, 80, 123}));
