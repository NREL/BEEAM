...
model Scenario_5_Data_Set_5_3
  ...
  DC.DC_Load     Laptop_6(pwr=41.465)  annotation (
  ...
  DC.DC_Load     Latop_5(pwr=40.475)  annotation (
  ...
  DC.DC_Load     Laptop_4(pwr=428.218) annotation (
  ...
  DC.DC_Load LumpedDCLoads(pwr=428.218) annotation (Placement(visible=true,
        transformation(
        origin={14,-32},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
