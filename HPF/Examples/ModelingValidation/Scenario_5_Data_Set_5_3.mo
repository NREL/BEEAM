...
model Scenario_5_Data_Set_5_3
  ...
  Modelica.Electrical.Analog.Basic.Ground ground3 annotation(
    Placement(visible = true, transformation(origin = {124, -118}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  HPF.DC.DC_Load Laptop_3(pwr = 72.741145) annotation(
    Placement(visible = true, transformation(origin = {100, 6}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  SinglePhase.Components.Terminate terminate2 annotation(
  ...
  HPF.DC.DC2DC_Converters.StepDown stepDown(modelData = modelData) annotation(
    Placement(visible = true, transformation(origin = {58, -48}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.DC.DC2DC_Converters.StepDown stepDown1(modelData = modelData) annotation(
    Placement(visible = true, transformation(origin = {58, -88}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.DC.DC_Load dC_Load(pwr = 9) annotation(
    Placement(visible = true, transformation(origin = {102, -48}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
...
equation
  ...
  connect(deltaWye.pinSec_A, Laptop_Charger_3.hPin_P) annotation(
    Line(points = {{-84, 16}, {-34, 16}}, color = {92, 53, 102}));
  connect(voltageSource.pinN, ground.pin) annotation(
    Line(points = {{-148, -8.75}, {-148, -20}}, color = {117, 80, 123}));
  connect(Laptop_Charger_3.hPin_N, ground6.pin) annotation(
    Line(points = {{-34, 4}, {-50, 4}, {-50, 0}}, color = {117, 80, 123}));
  connect(conv1.p2, Laptop_3.p) annotation(
    Line(points = {{66, 16}, {100, 16}}, color = {0, 0, 255}));
  ...
  connect(Laptop_Charger_3.pin_p, conv1.p1) annotation(
    Line(points = {{-14, 16}, {46, 16}}, color = {0, 0, 255}));
  connect(Laptop_Charger_3.pin_n, conv1.n1) annotation(
    Line(points = {{-14, 4}, {18, 4}, {18, -4}, {46, -4}}, color = {0, 0, 255}));
  connect(conv1.n2, Laptop_3.n) annotation(
    Line(points = {{66, -4}, {100, -4}}, color = {0, 0, 255}));
  ...
  connect(conv1.n1, ground1.p) annotation(
    Line(points = {{46, -4}, {18, -4}, {18, -12}}, color = {0, 0, 255}));
  connect(voltageSource.pinP_phC, deltaWye.pinPrim_C) annotation(
    Line(points = {{-135.5, -6}, {-104, -6}}, color = {92, 53, 102}));
  connect(stepDown.p2, dC_Load.p) annotation(
    Line(points = {{68, -38}, {102, -38}}, color = {0, 0, 255}));
  connect(stepDown.n2, dC_Load.n) annotation(
    Line(points = {{68, -58}, {102, -58}}, color = {0, 0, 255}));
  connect(stepDown1.p2, dC_Load1.p) annotation(
    Line(points = {{68, -78}, {102, -78}}, color = {0, 0, 255}));
  connect(stepDown1.n2, dC_Load1.n) annotation(
    Line(points = {{68, -98}, {102, -98}}, color = {0, 0, 255}));
  connect(Laptop_3.n, ground3.p) annotation(
    Line(points = {{100, -4}, {124, -4}, {124, -108}}, color = {0, 0, 255}));
  connect(dC_Load.n, ground3.p) annotation(
    Line(points = {{102, -58}, {124, -58}, {124, -108}}, color = {0, 0, 255}));
  connect(dC_Load1.n, ground3.p) annotation(
    Line(points = {{102, -98}, {124, -98}, {124, -108}}, color = {0, 0, 255}));
  connect(stepDown.p1, conv1.p1) annotation(
    Line(points = {{48, -38}, {26, -38}, {26, 16}, {46, 16}}, color = {0, 0, 255}));
  connect(stepDown1.p1, conv1.p1) annotation(
    Line(points = {{48, -78}, {26, -78}, {26, 16}, {46, 16}, {46, 16}}, color = {0, 0, 255}));
  connect(stepDown1.n1, conv1.n1) annotation(
    Line(points = {{48, -98}, {38, -98}, {38, -6}, {38, -6}, {38, -4}, {46, -4}, {46, -4}}, color = {0, 0, 255}));
