...
model Scenario_5_Data_Set_5_3
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl NextekHub( V_Rect = 25, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Nextek_120V_1600W.mat", nomP = 600) annotation(
