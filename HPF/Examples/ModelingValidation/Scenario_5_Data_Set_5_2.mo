...
model Scenario_5_Data_Set_5_2
  ...
  DC.DC_Load     Laptop_6(pwr=6.835)   annotation (
  ...
  DC.DC_Load     Latop_5(pwr=5.766)   annotation (
  ...
  DC.DC_Load     Laptop_4(pwr=5.766)   annotation (
  ...
  DC.DC_Load LumpedDCLoads(pwr=179.283) annotation (Placement(visible=true,
        transformation(
        origin={14,-32},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
...
equation
  ...
  connect(deltaWye.pinSec_B, terminate1.hPin_P)
    annotation (Line(points={{-86,8},{-73,8}}, color={92,53,102}));
  connect(deltaWye.pinSec_C, terminate2.hPin_P)
    annotation (Line(points={{-86,0},{-73,0}}, color={92,53,102}));
  ...
  annotation (
    Diagram(coordinateSystem(extent = {{-280, -220}, {260, 240}}, initialScale = 0.1), graphics={Text(lineColor = {28, 108, 200}, extent = {{-256, 64}, {-250, 64}}, textString = "Edit Here"),
                                                  Text(lineColor = {28, 108, 200}, extent = {{174, -126}, {234, -146}}, textString = "PhD 25V outputs
    "),
        Text(
          extent={{88,-28},{160,-42}},
