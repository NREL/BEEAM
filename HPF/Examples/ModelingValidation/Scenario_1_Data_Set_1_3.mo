...
equation
  ...
  annotation (
    Diagram(coordinateSystem(extent={{-300,-220},{300,240}},      initialScale = 0.1), graphics={Text(origin = {-8, -24}, lineColor = {28, 108, 200}, extent = {{-182, 192}, {146, 164}}, textString = "Scenario 1 | Data Set 1.3
