...
model Scenario_1_Data_Set_1_3
  ...
  HPF.Transformers.ThreePhase.DeltaWye deltaWye(Rp = 2.7672, Xp = 1.1006, Rs = 0.2576, Xs = 0.5003, Rc = 3.7626e+03, Xm = 711.1091, fW = 0.9, fEC = 0.0670, fOSL = 0.0330) annotation (
...
equation
  ...
  connect(deltaWye.pinSec_B, LED_Driver_2.hPin_P) annotation (Line(points={{-90,
          10},{94,10},{94,64},{134,64}}, color={92,53,102}));
  connect(Power_Supply_2.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points={{
          134,18},{94,18},{94,64},{134,64}}, color={92,53,102}));
  connect(Laptop_Charger_4.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points=
         {{132,-28},{94,-28},{94,64},{134,64}}, color={92,53,102}));
  connect(deltaWye.pinSec_A, LED_Driver_1.hPin_P) annotation (Line(points={{-90,
          18},{-6,18},{-6,138},{32,138}}, color={92,53,102}));
  connect(Power_Supply_1.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points={{
          30,94},{-6,94},{-6,138},{32,138}}, color={92,53,102}));
  connect(Laptop_Charger_3.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points=
         {{32,46},{-6,46},{-6,138},{32,138}}, color={92,53,102}));
  connect(deltaWye.pinSec_C, LED_Driver_3.hPin_P) annotation (Line(points={{-90,
          2},{-6,2},{-6,-14},{34,-14}}, color={92,53,102}));
  connect(Power_Supply_3.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points={{
          30,-62},{-6,-62},{-6,-14},{34,-14}}, color={92,53,102}));
  connect(Laptop_Charger_5.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points=
         {{26,-110},{-6,-110},{-6,-14},{34,-14}}, color={92,53,102}));
  annotation (
...
Load Phase c-n        Total Load - 300W                Load Bank (78W), LED (22W), Resistor (200W)", fontSize = 9,
