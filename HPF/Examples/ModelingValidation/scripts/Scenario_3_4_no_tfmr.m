...
linePowersSim = struct(); % line powers simulation structure
if dataSet == 1 || (scenario == 3 && dataSet == 2)
    linePowersSim.phA = LedDriver_1.AC.P + LaptopCharger_3.AC.P;
    linePowersSim.phB = LedDriver_2.AC.P + LaptopCharger_4.AC.P;
    linePowersSim.phC = LedDriver_3.AC.P + LaptopCharger_5.AC.P;
elseif scenario == 3 
    if dataSet == 3
