...
model Scenario_6_Data_Set_6_1
  ...
  DC.DC_Load     Laptop_6(pwr=0.304)   annotation (
  ...
  DC.DC2DC_Converters.StepDown     LaptopCharger_6(modelData=
        laptop_18V_90W_LapChrg6)                                           annotation (
    Placement(visible = true, transformation(origin = {44, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DC.DC_Load     Latop_5(pwr=0.109)   annotation (
    Placement(visible = true, transformation(origin = {74, 52}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  DC.DC2DC_Converters.StepDown     LaptopCharger_5(modelData=
        laptop_18V_90W_LapChrg5)                                          annotation (
    Placement(visible = true, transformation(origin = {44, 52}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DC.DC_Load     Laptop_4(pwr=0.109)   annotation (
    Placement(visible = true, transformation(origin = {74, 98}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  DC.DC2DC_Converters.StepDown     LaptopCharger_4(modelData=
        laptop_18V_90W_LapChrg4)                                          annotation (
  ...
  Data.ConverterModels.DC2DC_StepDown.Laptop_18V_90W_LapChrg4
    laptop_18V_90W_LapChrg4
    annotation (Placement(transformation(extent={{162,64},{182,84}})));
  Data.ConverterModels.DC2DC_StepDown.Laptop_18V_90W_LapChrg5
    laptop_18V_90W_LapChrg5
    annotation (Placement(transformation(extent={{164,38},{184,58}})));
  Data.ConverterModels.DC2DC_StepDown.Laptop_18V_90W_LapChrg6
    laptop_18V_90W_LapChrg6
    annotation (Placement(transformation(extent={{162,16},{182,36}})));
equation
  ...
  connect(terminate.hPin_P, deltaWye.pinSec_B)
    annotation (Line(points={{-61,8},{-86,8}}, color={92,53,102}));
  connect(terminate1.hPin_P, deltaWye.pinSec_C)
    annotation (Line(points={{-61,0},{-86,0}}, color={92,53,102}));
  annotation (
    Diagram(coordinateSystem(extent = {{-280, -220}, {260, 240}}), graphics={  Text(textString = "Edit Here", extent = {{-256, 64}, {-250, 64}}, lineColor = {28, 108, 200}),
                                                  Text(extent = {{174, -126}, {234, -146}}, lineColor = {28, 108, 200}, textString = "PhD 25V outputs
    "), Text(
          extent={{88,-28},{160,-42}},
