...
model Scenario_2_Data_Set_2_1
  ...
  SinglePhase.Components.Ground     ground2 annotation (
    Placement(visible = true, transformation(origin={-144,0},      extent={{-10,-10},
            {10,10}},                                                                               rotation = 0)));
  Transformers.ThreePhase.Symmetric.D1Y deltaWye(Rc = 15117.5, Rp = 8.333, Rs = 1.4404E-01, Xm = 2.3311e+03, Xp = 3.3002, Xs = 0.6197)
    annotation (Placement(transformation(extent={{-166,28},{-146,48}})));
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl LED_Driver_2(P1(start = 1e-2), S1(start = 1e-2), V_Rect=24,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Mean-Well-APV-25-24-2of3.mat",
    nomP = 25.2, nomV = 120) annotation (
    Placement(visible = true, transformation(origin={80,92},     extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Power_Supply_1(P1(start = 1e-2), S1(start = 1e-2), P_DCmin = 8, P_stby = 23.34,V_Rect=48,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Mean-Well-RSP-1000-48.mat",
    nomP = 1000, nomV = 120) annotation (
    Placement(visible = true, transformation(origin={-24,122},  extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Laptop_Charger_3(P1(start = 1e-2), S1(start = 1e-2), P_DCmin = 2, P_stby = 0.44,V_Rect=
        18.5, modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/HP-391174-001.mat",
    nomP = 120, nomV = 120) annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl LED_Driver_3(P1(start = 1e-2), S1(start = 1e-2), V_Rect=24,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Mean-Well-APV-25-24-3of3.mat",
    nomP = 25.2, nomV = 120) annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl LED_Driver_1(P1(start = 1e-2), S1(start = 1e-2), V_Rect=24,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Mean-Well-APV-25-24-1of3.mat",
    nomP = 25.2, nomV = 120) annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Laptop_Charger_4(P1(start = 1e-2), S1(start = 1e-2), P_DCmin = 2, P_stby = 0.33,V_Rect=
        18.5, modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/HP-PA-1900-15C2.mat",
    nomP = 90, nomV = 120) annotation (
    Placement(visible = true, transformation(origin={78,0},       extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Laptop_Charger_5(P1(start = 1e-2), S1(start = 1e-2), P_DCmin = 2, P_stby = 0.27,V_Rect=
        18.5, modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/HP-PA-1121-12H.mat",
    nomP = 120, nomV = 120) annotation (
    Placement(visible = true, transformation(origin={-28,-82},    extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Power_Supply_2(P1(start = 1e-2), S1(start = 1e-2), P_DCmin = 10, P_stby = 4.89,V_Rect=48,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Xunbuma-T-1000-48.mat",
    nomP = 1000, nomV = 120) annotation (
    Placement(visible = true, transformation(origin={80,46},      extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Power_Supply_3(P1(start = 1e-2), S1(start = 1e-2), P_DCmin = 10, P_stby = 17.7,V_Rect=48,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Mean-Well-SE-1000-48.mat",
    nomP = 1000, nomV = 120) annotation (
...
equation
  ...
  connect(voltageSource.pinP_phA, deltaWye.pinPrim_A)
    annotation (Line(points={{-217.5,48},{-166,48}}, color={92,53,102}));
  connect(voltageSource.pinP_phB, deltaWye.pinPrim_B)
    annotation (Line(points={{-217.5,38},{-166,38}}, color={92,53,102}));
  connect(voltageSource.pinP_phC, deltaWye.pinPrim_C)
    annotation (Line(points={{-217.5,28},{-166,28}}, color={92,53,102}));
  ...
  connect(deltaWye.pinSec_B, LED_Driver_2.hPin_P) annotation (Line(points={{-146,
          42},{-62,42},{-62,38},{40,38},{40,98},{70,98}}, color={92,53,102}));
  connect(Power_Supply_2.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points={{
          70,52},{40,52},{40,98},{70,98}}, color={92,53,102}));
  connect(Laptop_Charger_4.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points=
         {{68,6},{40,6},{40,98},{70,98}}, color={92,53,102}));
  connect(deltaWye.pinSec_C, LED_Driver_3.hPin_P) annotation (Line(points={{-146,
          34},{-100,34},{-100,20},{-30,20}}, color={92,53,102}));
  connect(Power_Supply_3.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points={{
          -34,-28},{-100,-28},{-100,20},{-30,20}}, color={92,53,102}));
  connect(Laptop_Charger_5.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points=
         {{-38,-76},{-100,-76},{-100,20},{-30,20}}, color={92,53,102}));
  connect(deltaWye.pinSec_A, LED_Driver_1.hPin_P) annotation (Line(points={{-146,
          50},{-78,50},{-78,172},{-32,172}}, color={92,53,102}));
  connect(Power_Supply_1.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points={{
          -34,128},{-78,128},{-78,172},{-32,172}}, color={92,53,102}));
  connect(Laptop_Charger_3.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points=
         {{-32,80},{-78,80},{-78,172},{-32,172}}, color={92,53,102}));
  annotation (
    Diagram(coordinateSystem(extent={{-300,-220},{260,240}},      initialScale = 0.1), graphics={Text(origin={
              -56,-16},                                                                                                    lineColor = {28, 108, 200}, extent = {{-182, 192}, {146, 164}}, textString = "Scenario 2 | Data Set 2.1
