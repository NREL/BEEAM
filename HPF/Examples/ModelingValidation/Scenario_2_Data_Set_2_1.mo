...
equation
  ...
  annotation (
    Diagram(coordinateSystem(extent={{-300,-220},{260,240}},      initialScale = 0.1), graphics={Text(origin={-6,
              -24},                                                                                                        lineColor = {28, 108, 200}, extent = {{-182, 192}, {146, 164}}, textString = "Scenario 2 | Data Set 2.1
