...
model Scenario_2_tmp
  ...
  HPF.Sensors.CurrentSensor iMsr_prim_PhA annotation (
    Placement(visible = true, transformation(origin = {-146, 58}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(voltageSource.pinP_phB, iMsr_prim_PhA.pin_p) annotation (
    Line(points = {{-168, 56}, {-156, 56}, {-156, 58}}, color = {92, 53, 102}));
  connect(iMsr_prim_PhA.pin_n, deltaWye.pinPrim_A) annotation (
    Line(points = {{-136, 58}, {-78, 58}}, color = {117, 80, 123}));
  ...
  connect(LED_Driver_3.hPin_P, deltaWye.pinSec_C) annotation (
    Line(points = {{28, -10}, {-30, -10}, {-30, 44}, {-58, 44}}, color = {92, 53, 102}));
  ...
  connect(deltaWye.pinSec_B, Laptop_Charger_4.hPin_P) annotation (
    Line(points = {{-58, 52}, {-20, 52}, {-20, 0}, {98, 0}, {98, -24}, {122, -24}}, color = {92, 53, 102}));
  annotation (
