...
model Scenario_2_Data_Set_2_3
  ...
  SinglePhase.Components.Ground     ground2 annotation (
    Placement(visible = true, transformation(origin={-30,-24},     extent={{-10,-10},
            {10,10}},                                                                               rotation = 0)));
...
equation
  ...
  connect(voltageSource.pinP_phA, deltaWye.pinPrim_A)
    annotation (Line(points={{-73.5,24},{-56,24}},   color={92,53,102}));
  connect(voltageSource.pinP_phB, deltaWye.pinPrim_B)
    annotation (Line(points={{-73.5,14},{-56,14}},   color={92,53,102}));
  connect(voltageSource.pinP_phC, deltaWye.pinPrim_C)
    annotation (Line(points={{-73.5,4},{-56,4}},   color={92,53,102}));
  ...
  connect(deltaWye.pinSec_A, LED_Driver_1.hPin_P) annotation (Line(points={{-36,26},
          {-2,26},{-2,90},{32,90}},       color={92,53,102}));
  connect(Power_Supply_1.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points={{32,58},
          {-2,58},{-2,90},{32,90}},          color={92,53,102}));
  connect(Laptop_Charger_3.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points={{32,26},
          {-2,26},{-2,90},{32,90}},                           color={92,53,102}));
  connect(deltaWye.pinSec_B, LED_Driver_2.hPin_P) annotation (Line(points={{-36,18},
          {-4,18},{-4,-10},{100,-10},{100,42},{134,42}},       color={92,53,102}));
  ...
  connect(deltaWye.pinSec_C, LED_Driver_3.hPin_P) annotation (Line(points={{-36,10},
          {-18,10},{-18,-20},{30,-20}},                color={92,53,102}));
  connect(Power_Supply_3.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points={{30,-54},
          {-4,-54},{-4,-20},{30,-20}},                    color={92,53,102}));
  connect(Laptop_Charger_5.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points={{30,-88},
          {-4,-88},{-4,-20},{30,-20}},                       color={92,53,102}));
  annotation (
