...
model Scenario_4_Data_Set_4_3
  ...
  Loads.UserDefined.HarmonicPQLoad Heater_2B(P = {384.674}) annotation(
    Placement(visible = true, transformation(origin = {140, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  DC.DC_Load LED_1(pwr = 29.288) annotation(
  ...
  Loads.UserDefined.HarmonicPQLoad Heater_1C(P = {188.951}) annotation(
  ...
  HPF.Loads.UserDefined.HarmonicPQLoad Heater_2C(P = {396.256}) annotation(
...
equation
  ...
  annotation(
    Diagram(coordinateSystem(extent = {{-280, -220}, {260, 240}}), graphics = {Text(extent = {{-258, 182}, {182, 136}}, lineColor = {28, 108, 200}, horizontalAlignment = TextAlignment.Left, textString = "Data Set 4.3
