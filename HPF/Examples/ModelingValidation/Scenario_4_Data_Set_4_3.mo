...
model Scenario_4_Data_Set_4_3
  ...
  Loads.UserDefined.HarmonicPQLoad Heater_1A(P = {193.350}) annotation(
    Placement(visible = true, transformation(origin = {54, 72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PowerConverters.SinglePhase.ACDC_EmpMdl LED_Driver_3(V_Rect = 24, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/LED_Driver_3.mat", nomP = 28, vAngle = 2.0944) annotation(
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl Laptop_Charger_4(P_DCmin = 2, P_stby = 0.33, V_Rect = 18.5, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Laptop_Charger_4.mat", nomP = 72, vAngle = -2.0944) annotation(
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl LED_Driver_2(V_Rect = 24, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/LED_Driver_2.mat", nomP = 28, vAngle = -2.0944) annotation(
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl Laptop_Charger_5(P_DCmin = 2, P_stby = 0.27, V_Rect = 18.5, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Laptop_Charger_5.mat", nomP = 72, vAngle = 2.0944) annotation(
  ...
  Loads.UserDefined.HarmonicPQLoad Heater_1C(P = {188.951}, vAngle = 2.0944) annotation(
  ...
  Loads.UserDefined.HarmonicPQLoad Heater_2B(P = {384.674}, vAngle = -2.0944) annotation(
