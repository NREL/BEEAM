...
model Scenario_4_Data_Set_4_4
  ...
  Loads.UserDefined.HarmonicPQLoad Heater_2B(P = {383.618}) annotation(
...
equation
  ...
  connect(Laptop_Charger_3.hPin_N, ground1.pin) annotation(
    Line(points = {{28, 8}, {12, 8}, {12, -10}}, color = {117, 80, 123}));
  connect(LED_Driver_2.hPin_N, ground17.pin) annotation(
    Line(points = {{128, -20}, {110, -20}, {110, -68}}, color = {117, 80, 123}));
  connect(LED_Driver_1.hPin_N, ground1.pin) annotation(
    Line(points = {{30, 52}, {12, 52}, {12, -10}}, color = {117, 80, 123}));
  ...
  connect(Heater_2B.hPin_P, LED_Driver_2.hPin_P) annotation(
    Line(points = {{115, 14}, {98, 14}, {98, -8}, {128, -8}}, color = {92, 53, 102}));
  ...
  connect(Laptop_Charger_4.hPin_N, ground17.pin) annotation(
    Line(points = {{128, -66}, {127, -66}, {127, -68}, {110, -68}}, color = {117, 80, 123}));
