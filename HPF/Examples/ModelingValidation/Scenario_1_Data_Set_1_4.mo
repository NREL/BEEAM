...
model Scenario_1_Data_Set_1_4
  ...
  SinglePhase.Components.Ground     ground2 annotation (
    Placement(visible = true, transformation(origin={-72,-36},     extent={{-10,-10},
            {10,10}},                                                                               rotation = 0)));
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl     Power_Supply_1(P_DCmin = 8, P_stby = 23.34,V_Rect=48,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Power_Supply_1.mat",
    nomP=400)                                                                                                                                                                            annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl     Laptop_Charger_3(P_DCmin = 2, P_stby = 0.44,V_Rect=
        18.5, modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Laptop_Charger_3.mat",
    nomP=72)                                                                                                                                                                                   annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl     Laptop_Charger_4(P_DCmin = 2, P_stby = 0.33,V_Rect=
        18.5, modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Laptop_Charger_4.mat",
    nomP=72)                                                                                                                                                                                   annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl     Laptop_Charger_5(P_DCmin = 2, P_stby = 0.27,V_Rect=
        18.5, modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Laptop_Charger_5.mat",
    nomP=72)                                                                                                                                                                                   annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl     Power_Supply_2(P_DCmin = 10, P_stby = 4.89,V_Rect=48,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Power_Supply_2.mat",
    nomP=400)                                                                                                                                                                            annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl     Power_Supply_3(P_DCmin = 10, P_stby = 17.7,V_Rect=48,
      modelFileName="HPF/Data/ConverterModels/SinglePhase/ACDC/Power_Supply_3.mat",
    nomP=400)                                                                                                                                                                            annotation (
  ...
  SinglePhase.Components.Ground     ground6 annotation (
    Placement(visible = true, transformation(origin={14,-162},     extent={{-10,-10},
            {10,10}},                                                                               rotation = 0)));
equation
  ...
  connect(voltageSource.pinP_phA, deltaWye.pinPrim_A) annotation (Line(points={{-145.5,
          12},{-94,12}},                    color={92,53,102}));
  connect(voltageSource.pinP_phB, deltaWye.pinPrim_B)
    annotation (Line(points={{-145.5,2},{-94,2}},    color={92,53,102}));
  connect(voltageSource.pinP_phC, deltaWye.pinPrim_C)
    annotation (Line(points={{-145.5,-8},{-94,-8}},  color={92,53,102}));
  ...
  connect(LED_Driver_3.hPin_N, ground6.pin) annotation (Line(points={{36,-34},{14,
          -34},{14,-150.75}}, color={117,80,123}));
  connect(Power_Supply_3.hPin_N, ground6.pin) annotation (Line(points={{32,-82},
          {14,-82},{14,-150.75}}, color={117,80,123}));
  connect(Laptop_Charger_5.hPin_N, ground6.pin) annotation (Line(points={{28,-130},
          {14,-130},{14,-150.75}}, color={117,80,123}));
  connect(Laptop_Charger_3.hPin_N, ground5.pin)
    annotation (Line(points={{34,26},{10,26},{10,7.25}}, color={117,80,123}));
  connect(Power_Supply_1.hPin_N, ground5.pin)
    annotation (Line(points={{32,74},{10,74},{10,7.25}}, color={117,80,123}));
  connect(LED_Driver_1.hPin_N, ground5.pin) annotation (Line(points={{34,118},{10,
          118},{10,7.25}}, color={117,80,123}));
  connect(deltaWye.pinSec_A, LED_Driver_1.hPin_P) annotation (Line(points={{-74,
          14},{-12,14},{-12,130},{34,130}}, color={92,53,102}));
  connect(Power_Supply_1.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points={{
          32,86},{-12,86},{-12,130},{34,130}}, color={92,53,102}));
  connect(Laptop_Charger_3.hPin_P, LED_Driver_1.hPin_P) annotation (Line(points=
         {{34,38},{-12,38},{-12,130},{34,130}}, color={92,53,102}));
  connect(deltaWye.pinSec_B, LED_Driver_2.hPin_P) annotation (Line(points={{-74,
          6},{-58,6},{-58,-2},{100,-2},{100,56},{136,56}}, color={92,53,102}));
  connect(Power_Supply_2.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points={{
          136,10},{100,10},{100,56},{136,56}}, color={92,53,102}));
  connect(Laptop_Charger_4.hPin_P, LED_Driver_2.hPin_P) annotation (Line(points=
         {{134,-36},{100,-36},{100,56},{136,56}}, color={92,53,102}));
  connect(deltaWye.pinSec_C, LED_Driver_3.hPin_P) annotation (Line(points={{-74,
          -2},{-64,-2},{-64,-22},{36,-22}}, color={92,53,102}));
  connect(Power_Supply_3.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points={{
          32,-70},{-4,-70},{-4,-22},{36,-22}}, color={92,53,102}));
  connect(Laptop_Charger_5.hPin_P, LED_Driver_3.hPin_P) annotation (Line(points=
         {{28,-118},{-4,-118},{-4,-22},{36,-22}}, color={92,53,102}));
  annotation (
    Diagram(coordinateSystem(extent={{-300,-220},{280,240}},      initialScale = 0.1), graphics={Text(origin = {-14.44, 1.71}, lineColor = {28, 108, 200}, extent = {{-177.56, 178.29}, {142.44, 152.29}}, textString = "Scenario 1 | Data Set 1.4
...
Load Phase c-n        Total Load - 500W                Load Bank (78W), LED (22W), Resistor (400W)",
