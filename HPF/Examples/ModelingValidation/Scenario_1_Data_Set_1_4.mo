...
model Scenario_1_Data_Set_1_4
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Power_Supply_1(P_DCmin = 8, P_stby = 23.34, V_Rect = 48, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Power_Supply_1.mat", nomP = 400) annotation (
  ...
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Power_Supply_2(P_DCmin = 10, P_stby = 4.89, V_Rect = 48, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Power_Supply_2.mat", nomP = 400) annotation (
    Placement(visible = true, transformation(origin = {146, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerConverters.SinglePhase.ACDC_EmpMdl Power_Supply_3(P_DCmin = 10, P_stby = 17.7, V_Rect = 48, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Power_Supply_3.mat", nomP = 400) annotation (
