within HPF.Examples;
model MATLAB_Implementation_coupled
  import Modelica.ComplexMath.j;
  inner HPF.SystemDef systemDef(hrms = {i for i in 1:2:25}) annotation (
    Placement(visible = true, transformation(origin={-78.1847,58.4921},    extent = {{-9.81534, -9.81533}, {9.81534, 7.01095}}, rotation = 0)));
...
equation
  connect(load.pin_n, ground.pin) annotation (
    Line(points={{-26,-10},{-26,-16.75},{-64,-16.75}},  color = {117, 80, 123}));
  connect(V0.pin_n, ground.pin) annotation (
    Line(points={{-64,-10},{-64,-16.75}},   color = {117, 80, 123}));
  ...
  connect(Z12.pin_n, ground.pin) annotation (
    Line(points={{6,20},{14,20},{14,-16.75},{-64,-16.75}},    color = {117, 80, 123}));
...
end MATLAB_Implementation_coupled;
