...
model MATLAB_Implementation_Cmplx
  ...
  inner HPF.SystemDef systemDef(hrms={i for i in 1:2:20})   annotation (
    Placement(visible = true, transformation(origin = {-54.1847, 38.4921}, extent = {{-9.81534, -9.81533}, {9.81534, 7.01095}}, rotation = 0)));
...
equation
  connect(load.pin_n, ground.pin) annotation(
    Line(points = {{-20, -10}, {-20, -18}, {-64, -18}}, color = {117, 80, 123}));
  ...
  connect(load.pin_p, Z12.pin_p) annotation(
    Line(points = {{-20, 10}, {-20, 20}, {-2, 20}}));
  connect(Z12.pin_n, ground.pin) annotation(
    Line(points = {{18, 20}, {28, 20}, {28, -18}, {-64, -18}}, color = {117, 80, 123}));
  connect(Z01.pin_n, load.pin_p) annotation(
    Line(points = {{-36, 20}, {-20, 20}, {-20, 10}}, color = {117, 80, 123}));
  annotation (
