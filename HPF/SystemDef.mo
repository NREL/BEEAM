...
algorithm
  ...
  annotation (
    ...
    Icon(coordinateSystem(grid = {0, 0}, extent = {{-140, -140}, {140, 100}}, initialScale = 0.1), graphics={  Rectangle(origin = {-40, 0}, lineColor = {92, 53, 102}, extent = {{-100, 100}, {180, -140}}), Line(origin = {-41.812, 59.8666}, points = {{-98, 0}, {182, 0}}, color = {92, 53, 102}), Text(origin = {-88, 25}, extent = {{-46, 25}, {418, -5}}, textString = "Harmonics=",
            horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left), Text(origin = {-96, -53}, extent = {{-38, 23}, {426, -7}},
            horizontalAlignment=TextAlignment.Left,
          textString="Fundamental=%fFund",
          lineColor={0,0,0}),                                                                                                                                                                                                        Text(origin = {-210, 87}, lineColor = {92, 53, 102}, fillColor = {92, 53, 102}, extent = {{-40, 13}, {458, -27}}, textString = "System Setup", textStyle = {TextStyle.Bold}),  Text(origin = {-52, -13}, extent = {{-42, 25}, {444, -7}}, textString = "%hrms",
            horizontalAlignment =                                                                                                                                                                                                        TextAlignment.Left),Text(origin = {-96, -93}, extent = {{-38, 23}, {476, -7}},
            horizontalAlignment=TextAlignment.Left,
