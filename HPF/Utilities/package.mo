...
package Utilities
  ...
  partial model WireGaugeValues
    ...
    final parameter Real gaugeResistanceDC[21] = {26.1, 16.4, 10.3, 6.5, 4.07, 2.551, 1.608, 1.01, 0.802, 0.634, 0.505, 0.399, 0.317, 0.2512, 0.1996, 0.1687, 0.1409, 0.1205, 0.1053, 0.0845, 0.0704}  "DC gauge to resistance in ohms per 1000 meters";
    annotation(
