...
model Test_1
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl          laptop_adapter(V_Rect = 24, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/Laptop_Charger_3.mat", nomP = 100) annotation (
