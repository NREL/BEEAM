...
model Scenario_2_Data_Set_2_3
  ...
  inner HPF.SystemDef systemDef(fs = 10e3, hrms = {i for i in 1:2:10}) annotation (
  ...
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase_InitMdl Power_Supply_1(V_Rect = 48, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Power_Supply_1_3D.mat", nomP = 200) annotation (
    Placement(visible = true, transformation(origin={78, 44},       extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase_InitMdl Laptop_Charger_3(V_Rect = 18.5, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Laptop_Charger_3_3D.mat", nomP = 78) annotation (
  ...
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase_InitMdl LED_Driver_3(V_Rect = 24, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_LED_Driver_3_3D.mat", nomP = 28) annotation (
  ...
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase_InitMdl Laptop_Charger_4(V_Rect = 18.5, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Laptop_Charger_4_3D.mat", nomP = 78) annotation (
    Placement(visible = true, transformation(origin={180, -78},    extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase_InitMdl Power_Supply_2(V_Rect = 48, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Power_Supply_2_3D.mat", nomP = 400) annotation (
    Placement(visible = true, transformation(origin={182, -32},     extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase_InitMdl Power_Supply_3(V_Rect = 48, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Power_Supply_3_3D.mat", nomP = 600) annotation (
  ...
  HPF.Transformers.ThreePhase.DeltaWye_test deltaWye(Rc = 3988.52, Rp = 2.78, Rs = 0.2558,VPrimRated = 480, VSecRated = 208, Xm = 750.4548, Xp = 1.1006, Xs = 0.2066,fEC = 0.067, fOSL = 0.033, fW = 0.9) annotation (
    Placement(visible = true, transformation(origin = {-68, -10}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
  ...
  PowerElectronicsConverters.AC2DC_SinglePhase_InitMdl Laptop_Charger_5(V_Rect = 18.5, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Laptop_Charger_5_3D.mat", nomP = 78) annotation (
  ...
  DC.DC_Load dC_Load2(pwr = 71.420897) annotation (
...
equation
  ...
  connect(iMsr_Sec_phA.pin_n, Power_Supply_1.hPin_P) annotation (
    Line(points = {{2, 16}, {42, 16}, {42, 50}, {68, 50}}, color = {117, 80, 123}));
  ...
  connect(iMsr_Sec_phB.pin_n, Laptop_Charger_4.hPin_P) annotation (
    Line(points = {{24, -6}, {40, -6}, {40, -46}, {136, -46}, {136, -72}, {170, -72}}, color = {117, 80, 123}));
  connect(iMsr_Sec_phC.pin_n, LED_Driver_3.hPin_P) annotation (
    Line(points = {{30, -32}, {34, -32}, {34, -58}, {72, -58}, {72, -58}}, color = {117, 80, 123}));
  connect(Power_Supply_3.hPin_P, iMsr_Sec_phC.pin_n) annotation (
    Line(points = {{68, -106}, {10, -106}, {10, -58}, {34, -58}, {34, -32}, {30, -32}, {30, -32}}, color = {92, 53, 102}));
