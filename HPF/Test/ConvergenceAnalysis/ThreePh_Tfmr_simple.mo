...
model ThreePh_Tfmr_simple
  ...
  Transformers.ThreePhase.Symmetric.D1Y     deltaWye(Rc = 8.4e3, Rp = 3.7672, Rs = 0.2576, VPrimRated = 480, VSecRated = 208, Xm = 777.0164, Xp = 1.1006, Xs = 0.5003)                                      annotation (
    Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl          Laptop_Charger_3(P1(start = 78), S1(start = 78), V_Rect = 18.5, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/HP-391174-001.mat", nomP = 120, nomV = 120) annotation (
  ...
  PowerConverters.SinglePhase.ACDC_EmpMdl          Laptop_Charger_4(P1(start = 78), S1(start = 78), V_Rect = 18.5, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/HP-PA-1900-15C2.mat", nomP = 90, nomV = 120) annotation (
    Placement(visible = true, transformation(origin = {142, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PowerConverters.SinglePhase.ACDC_EmpMdl          Laptop_Charger_5(P1(start = 78), S1(start = 78), V_Rect = 18.5, modelFileName = "HPF/Data/ConverterModels/SinglePhase/ACDC/HP-PA-1121-12H.mat", nomP = 120, nomV = 120) annotation (
...
equation
  ...
  connect(deltaWye.pinSec_N, ground2.pin) annotation (
    Line(points={{-24,-19.2},{1.5,-19.2},{1.5,-60.75},{4,-60.75}},color = {117, 80, 123}));
  connect(Laptop_Charger_3.hPin_P, deltaWye.pinSec_A) annotation (
    Line(points={{50,62},{20,62},{20,19.2},{-24,19.2}},      color = {92, 53, 102}));
  connect(Laptop_Charger_4.hPin_P, deltaWye.pinSec_B) annotation (
    Line(points={{132,6},{54,6},{54,6.4},{-24,6.4}},
                                        color = {92, 53, 102}));
  connect(Laptop_Charger_4.hPin_N, ground17.pin) annotation (
    Line(points={{132,-6},{114,-6},{114,-6.75},{114,-6.75}},      color = {117, 80, 123}));
  connect(deltaWye.pinSec_C, Laptop_Charger_5.hPin_P) annotation (
    Line(points={{-24,-6.4},{11.96,-6.4},{11.96,-6},{30,-6}},               color = {92, 53, 102}));
  connect(ground19.pin, Laptop_Charger_5.hPin_N) annotation (
    Line(points={{16,-32.75},{16,-32.75},{16,-18.75},{30,-18.75},{30,-18}},               color = {92, 53, 102}));
  connect(voltageSource.pinP_phA, deltaWye.pinPrim_A) annotation (
    Line(points={{-147.5,10},{-98,10},{-98,16},{-56,16}},            color = {92, 53, 102}));
  connect(voltageSource.pinP_phB, deltaWye.pinPrim_B) annotation (
    Line(points = {{-147.5, 0}, {-56, 0}}, color = {92, 53, 102}));
  connect(deltaWye.pinPrim_C, voltageSource.pinP_phC) annotation (
    Line(points = {{-56, -16}, {-98, -16}, {-98, -10}, {-147.5, -10}}, color = {92, 53, 102}));
  annotation (
    ...
    __OpenModelica_simulationFlags(lv = "LOG_INIT,LOG_INIT_V,LOG_RES_INIT,LOG_SIMULATION,LOG_SOLVER,LOG_SOLVER_V,LOG_SOLVER_CONTEXT,LOG_STATS,LOG_STATS_V,LOG_SUCCESS", outputFormat = "mat", s = "dassl", nls = "newton"),
