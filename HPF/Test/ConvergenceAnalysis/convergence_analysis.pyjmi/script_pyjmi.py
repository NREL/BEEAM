...
class_name = 'HPF.Test.ConvergenceAnalysis.Original_Implementation'
...
fmuObj = load_fmu(fmu_name, log_file_name='fmu_log.txt', log_level=4)

res = fmuObj.simulate(final_time=30)
"""
sine_y = res['sine.y']
