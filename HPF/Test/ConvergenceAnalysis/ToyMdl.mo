...
equation
  ...
  connect(a_vSrc.pin_n, ground1.pin) annotation(
    Line(points = {{-122, -4}, {-122, -29}}, color = {117, 80, 123}));
  ...
  connect(ground1.pin, T.pinN_prim) annotation(
    Line(points = {{-122, -29}, {-122, -8.75}, {-94, -8.75}, {-94, 6}, {-80, 6}}, color = {92, 53, 102}));
  connect(conv.hPin_P, T.pinP_sec) annotation(
    Line(points = {{24, -4}, {-16, -4}, {-16, 26}, {-60, 26}}, color = {92, 53, 102}));
  ...
  connect(conv.hPin_N, ground.pin) annotation(
    Line(points = {{24, -16}, {-42, -16}, {-42, -21}}, color = {117, 80, 123}));
  connect(Z.pin_p, T.pinP_sec) annotation(
    Line(points = {{44, 26}, {-60, 26}}, color = {92, 53, 102}));
  connect(Z.pin_n, ground4.pin) annotation(
    Line(points = {{64, 26}, {114, 26}, {114, 15}}, color = {117, 80, 123}));
  connect(T.pinN_sec, ground.pin) annotation(
    Line(points = {{-60, 6}, {-42, 6}, {-42, -21}}, color = {117, 80, 123}));
  annotation(
    ...
    __OpenModelica_simulationFlags(lv = "LOG_SIMULATION,LOG_SOLVER,LOG_SOLVER_CONTEXT,LOG_STATS,LOG_STATS_V,LOG_SUCCESS", outputFormat = "mat", s = "dassl", nls = "newton"));
end ToyMdl;