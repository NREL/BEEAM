...
model Converter_initialization
  ...
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase_InitiMdl aC2DC_SinglePhase_New  (V_Rect = 24, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Laptop_Charger_4_3D.mat", nomP = 100) annotation(
...
equation
  ...
  annotation(
    ...
    __OpenModelica_simulationFlags(lv = "LOG_JAC,LOG_NLS,LOG_NLS_V,LOG_NLS_RES,LOG_SOLVER,LOG_STATS", outputFormat = "mat", s = "dassl", nls = "newton"));
