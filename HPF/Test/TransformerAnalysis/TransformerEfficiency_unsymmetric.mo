...
model TransformerEfficiency_unsymmetric
  ...
  HPF.Transformers.ThreePhase.DeltaWye_Unsymmetric deltaWye(Rc = {10609.74, 11965.56, 22777.2}, Rp = {8.3016, 8.34, 8.3574}, Rs = {1.4511E-01, 1.4292E-01, 1.4410E-01}, Xm = {2.1333e3, 2.2514e3, 2.6085e3}, Xp = {0.6197, 0.6197, 0.6197}, Xs = {0.6197, 0.6197, 0.6197}, fEC = {0.067, 0.067, 0.067}, fOSL = {0.033, 0.033, 0.033}, fW = {0.9, 0.9, 0.9})  annotation (
...
end TransformerEfficiency_unsymmetric;
