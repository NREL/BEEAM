...
model Test_Rectifier
  ...
  HPF.PowerElectronicsConverters.AC2DC_SinglePhase laptop_adapter(V_Rect = 24, efficiency = 0.9, modelFileName = "HPF/PowerElectronicsConverters/AC2DC_ConverterModels/AC2DC_Laptop_Charger_4.mat") annotation (
...
equation
  ...
  connect(laptop_adapter.pin_n, ground2.p) annotation(
    Line(points = {{20, -50}, {20, -59}, {22, -59}, {22, -68}}, color = {0, 0, 255}));
  ...
  connect(ammeter_Freq2Time.pin_p, z.pin_n) annotation(
    Line(points = {{-46, -24}, {-58, -24}, {-58, 0}, {-72, 0}}));
