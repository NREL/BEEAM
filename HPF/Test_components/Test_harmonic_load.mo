...
//i[:].im = scaleFact*(iSpect_Mag[:].*sin(iSpect_Arg[:]));
  ...
  */
  annotation (
    Icon(coordinateSystem(grid = {0, 0}, initialScale = 0.1), graphics = {Rectangle(origin = {-1, 0}, extent = {{-79, 60}, {81, -60}}), Line(origin = {-19.9954, 4.22942}, points = {{0, 24}, {0, -24}}), Line(origin = {-9.22393, 4.28472}, points = {{0, 14}, {0, -24}}), Line(origin = {0.00458531, 4.42422}, points = {{0, 4}, {0, -24}}), Line(origin = {29.0461, 4.58262}, points = {{0, -12}, {0, -24}}), Line(origin = {19.7105, 4.55002}, points = {{0, -4}, {0, -24}}), Line(origin = {9.04607, 4.343}, points = {{0, 2}, {0, -24}}), Line(origin = {-1.22772, -19.9146}, rotation = -90, points = {{0, 36}, {0, -24}}), Text(origin = {-29, 171}, extent = {{-51, 33}, {97, -43}}, textString = "%name"), Line(origin = {-85, 1}, points = {{-5, -1}, {5, -1}, {5, 1}}), Line(origin = {85, 0}, points = {{-5, 0}, {5, 0}, {5, 0}})}),
