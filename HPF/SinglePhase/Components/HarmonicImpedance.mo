...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                                                                        Rectangle(lineColor = {92, 53, 102}, fillColor = {255, 255, 255},
            fillPattern =                                                                                                                               FillPattern.Solid, extent = {{-70, 30}, {70, -30}}), Text(origin={
              -40.4,3.2},                                                                                                                                                                                                        lineColor=
              {92,53,102},                                                                                                                                                                                                        extent={{
              -27.6,8.8},{110.4,-13.2}},
          textString="Z(h)=R(h)+jX(h)"),                                                                                                                                                                                                        Line(origin = {-85.07, -0.21}, points = {{-15, 0}, {15, 0}}, color = {92, 53, 102}), Line(origin = {85.0205, -0.21}, points = {{-15, 0}, {15, 0}}, color = {92, 53, 102}), Text(origin = {-24, -20}, lineColor = {92, 53, 102}, extent = {{-156, 60}, {204, 100}}, textString = "%name")}),
                                                                 Diagram(
...
<p>This component is necessitated in models requiring an impedance in which the resistance and the reactance are a function of harmonics. This component is different than the &apos;<a href=\"modelica://HPF/SinglePhase/Components/Impedance.mo\"> Impedance</a>&apos; component in way that the impedance is specified at the fundamental and the component internally computes the impedance at each harmonic.</p>
</html>"));
