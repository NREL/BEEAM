...
<p>Inductor is a linear circuit element with voltage and current relation at harmonic <i>h</i> given by <img src=\"modelica://HPF/Resources/images/SinglePhase/Components/Inductor/image001.png\"/>&nbsp;. Where <i>L</i> is the inductance. </p>
</html>"));
end Inductor;
