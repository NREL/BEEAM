...
model VoltageSrcLoadData "Harmonic Voltage Source (Load input data from a mat file, Example: \"Input/Directory/FileName\")"
  ...
  /*
      ...
      Solved! The settings in OMEdit were incorrectly configured. Resetting the settings resolved this.
    */
  /*
      ...
      Setting matrix variable names as:
        ...
        * arg
        ...
        TODO: this requires a tool to package data into a standard format. 
              Work on a GUI tool for this?
    */
  final parameter Integer matDim[2] = Modelica.Utilities.Streams.readMatrixSize(resourceRetVal, "magV");
  /*
      OpenModelica bug workaround;
        Setting matrix as a constant = 32
    */
  final parameter Real magDataMat[:, :] = Modelica.Utilities.Streams.readRealMatrix(resourceRetVal, "magV", matDim[1], 1);
  final parameter Real argDataMat[:, :] = Modelica.Utilities.Streams.readRealMatrix(resourceRetVal, "argV", matDim[1], 1);
  /*
  ...
  */
  ...
  annotation (
    ...
    Icon(graphics={  Ellipse(extent = {{-48, 50}, {48, -50}}, endAngle = 360), Line(origin = {-69, 0}, points = {{-21, 0}, {21, 0}}), Line(origin = {69, 0}, points = {{-21, 0}, {21, 0}}), Line(origin = {-8.2246, 18.6487}, points = {{8.50128, 21.0747}, {2.50128, 19.0747}, {-5.49872, 13.0747}, {-9.49872, 7.07465}, {-11.4987, -0.925349}, {-9.49872, -6.92535}, {-5.49872, -10.9253}, {0.501285, -14.9253}, {6.50128, -18.9253}, {8.50128, -18.9253}, {8.5013, -18.9253}}), Line(origin = {7.309, -18.9402}, rotation = 180, points = {{8.50128, 21.0747}, {2.50128, 19.0747}, {-5.49872, 13.0747}, {-9.49872, 7.07465}, {-11.4987, -0.925349}, {-9.49872, -6.92535}, {-5.49872, -10.9253}, {0.501285, -14.9253}, {6.50128, -18.9253}, {8.50128, -18.9253}, {8.5013, -18.9253}}), Text(origin = {-84, 47}, rotation = 90, extent = {{-14, 23}, {56, -19}}, textString = "%name"), Line(origin = {-0.240082, -69.5198}, rotation = 180, points={{
              -0.240082,-11.5198},{0,-20}},                                                                                                                                                                                                        arrow = {Arrow.None, Arrow.Filled}, arrowSize = 7), Rectangle(origin = {2, -101}, extent = {{-30, 29}, {26, -19}}), Text(origin = {-7, -105}, rotation = 90, extent = {{-9, 17}, {25, -29}}, textString = "File", textStyle = {TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold, TextStyle.Bold})}, coordinateSystem(initialScale = 0.1)));
