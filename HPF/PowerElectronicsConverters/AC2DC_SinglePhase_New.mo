...
model AC2DC_SinglePhase_New "AC to DC Converter Single Phase"
...
protected
  ...
  Real c[systemDef.numHrm - 1] = {HPF.Utilities.interpolateBilinear(mdl_H, mdl_P_h1, mdl_Z_mag, systemDef.hrms[i], P) for i in 2:1:systemDef.numHrm};
...
equation
  ...
  */
  argS = - HPF.Utilities.interpolateBilinear(mdl_H, mdl_P_h1, mdl_Z_arg, 1, P);
