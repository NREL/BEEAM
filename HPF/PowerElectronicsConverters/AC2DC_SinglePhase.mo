...
model AC2DC_SinglePhase "AC to DC Converter Single Phase"
  ...
  */
  Real P = abs(efficiency * (vDC.v * vDC.i));  // DC output power
...
equation
  ...
  */
  loadBase.i[2:1:end] = {c[i]*a[i] for i in 1:systemDef.numHrm-1};
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-200, -200}, {200, 200}}, grid = {0, 0}, initialScale = 0.1), graphics = {Line(origin = {-44.9857, 106.014}, points = {{-25.0143, -28.0143}, {20.9857, -26.0143}, {24.9857, 27.9857}}), Line(origin = {-17.2193, 129.664}, points = {{-3.06865, 9.53875}, {-15.0687, -14.4612}, {6.93135, -14.4612}, {-1.06865, 9.53875}})}),
