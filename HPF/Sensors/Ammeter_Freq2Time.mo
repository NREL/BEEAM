...
annotation (
    Icon(graphics = {Ellipse(origin = {-11, 0}, extent = {{-49, 60}, {71, -60}}, endAngle = 360), Line(origin = {-75, 0}, points = {{-15, 0}, {15, 0}}), Line(origin = {75, 0}, points = {{-15, 0}, {15, 0}}), Text(origin = {54, 8}, rotation = 90, lineThickness = 1, extent = {{-28, 70}, {12, -6}}, textString = "A", textStyle = {TextStyle.Bold}), Text(origin = {46, -55}, extent = {{-168, -3}, {78, -35}}, textString = "%name")}, coordinateSystem(initialScale = 0.1)));
