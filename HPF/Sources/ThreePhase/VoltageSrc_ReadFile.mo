...
annotation (
    Icon(graphics = {Rectangle(extent = {{-40, 100}, {100, -100}}), Ellipse(origin = {15, 7}, extent = {{-45, 53}, {75, -67}}, endAngle = 360), Text(origin = {-163, -15}, extent = {{-11, 3}, {115, -37}}, textString = ".mat"), Polygon(origin = {-41, 0}, fillPattern = FillPattern.Solid, points = {{-9, 10}, {-9, -10}, {9, 0}, {-9, 10}}), Rectangle(origin = {-54, 0}, fillPattern = FillPattern.Solid, extent = {{-8, 2}, {14, -2}}), Line(origin = {-106.63, -0.482898}, points = {{-49.9999, 60}, {-49.9999, -60}, {50.0001, -60}, {50.0001, 40}, {30.0001, 60}, {-49.9999, 60}}), Line(origin = {-105.118, 39.2524}, points = {{-33, 0}, {33, 0}}), Line(origin = {-105.211, 24.5816}, points = {{-33, 0}, {33, 0}}), Line(origin = {-104.93, 10.6584}, points = {{-33, 0}, {33, 0}}), Line(origin = {29.337, 0.860912}, points = {{-40.0807, -1.02713}, {-38.0807, 8.97287}, {-32.0807, 20.9729}, {-26.0807, 28.9729}, {-18.0807, 32.9729}, {-8.08074, 24.9729}, {-4.08074, 12.9729}, {-0.0807397, -1.02713}, {3.91926, -13.0271}, {5.91926, -19.0271}, {11.9193, -29.0271}, {21.9193, -35.0271}, {31.9193, -25.0271}, {35.9193, -17.0271}, {37.9193, -7.02713}, {39.9193, -1.02713}, {39.9193, -1.02713}}, smooth = Smooth.Bezier), Text(origin = {105, -93}, extent = {{-11, 3}, {35, -37}}, textString = "C"), Text(origin = {109, -15}, extent = {{-11, 3}, {35, -37}}, textString = "B"), Text(origin = {105, 69}, extent = {{-11, 3}, {35, -37}}, textString = "A"), Text(origin = {-56, 40}, lineColor = {92, 53, 102}, extent = {{-150, 60}, {254, 100}}, textString = "%name")}, coordinateSystem(initialScale = 0.1)),
