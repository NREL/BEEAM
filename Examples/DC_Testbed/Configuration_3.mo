...
model Configuration_3
  ...
  HPF.DC.DC2DC_Converters.EfficiencyCurves.EffyCurve_Test_1 effyCurve_Test_11 annotation(
...
* AC-DC loads.
* Delta-wye transformer (Unbalanced)", horizontalAlignment = TextAlignment.Left), Text(origin = {-127, 121}, extent = {{189, -61}, {-19, -21}}, textString = "TODO:
