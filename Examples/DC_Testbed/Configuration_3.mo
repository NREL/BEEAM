...
model Configuration_3
  ...
  HPF.SinglePhase.Components.Ground ground1 annotation (
    Placement(visible = true, transformation(origin = {-128, -96}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  HPF.SinglePhase.Sources.VoltageSrcLoadData PhB(fileName = "HPF/InputData/Examples/DC_Testbed/hrmsData_volt_prim_confAC_1_B.mat")  annotation (
    Placement(visible = true, transformation(origin = {-108, -64}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
...
equation
  ...
  annotation (
    ...
    Diagram(coordinateSystem(grid = {0, 0}, extent = {{-150, -150}, {150, 150}}, initialScale = 0.1), graphics={Text(origin = {-131, 113}, extent = {{69, 1}, {-17, 23}}, textString = "DC Testbed: Configuration 3
* AC-DC loads.
* Delta-wye transformer (Unbalanced)", horizontalAlignment = TextAlignment.Left), Text(origin = {-131, 127}, extent = {{127, -51}, {-19, -21}}, textString = "TODO:
* Verify Power calc quantities math (vector multiplication)
 in Voltage source", horizontalAlignment = TextAlignment.Left), Text(origin = {-133, 101}, extent = {{121, -3}, {-17, 23}}, textString = "Notes:
* Enable option: 'Save simulation flags inside model'", horizontalAlignment = TextAlignment.Left), Text(origin = {43, 133}, extent = {{-41, 19}, {105, -25}}, textString = "Todo Steps:
*Redo rectifier model with model loading from file
*Load input data from file
*Create Post processing code", horizontalAlignment = TextAlignment.Left)}),
