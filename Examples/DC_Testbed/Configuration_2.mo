...
model Configuration_2
  ...
  inner HPF.SystemDef systemDef(hrms = {1, 3, 5}) annotation(
    Placement(visible = true, transformation(origin = {-92, 70}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
  ...
  HPF.SinglePhase.NonlinearLoads.Rectifier led_driver_3(V_Rect = 100, efficiency = 0.95, hrmMdl_coefArg = {-5.02372881045404e-05, 0.00237063924944842, -1.49993957428169, 1.71994407623008}, hrmMdl_coefMag = {2.70064268049248e-05, -0.00156976101310340, -0.00600037080602108, 0.995516922015768}, rectifierModel = 1) annotation(
    Placement(visible = true, transformation(origin = {120, -114}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(led_driver_1.hPin_N, led_driver_2.hPin_N) annotation(
    Line(points = {{108, -30}, {105, -30}, {105, -30}, {102, -30}, {102, -76}, {110, -76}, {110, -76}, {108, -76}, {108, -76}}, color = {117, 80, 123}));
  ...
  connect(ground8.p, laptop_3.n) annotation(
    Line(points = {{72, -22}, {67, -22}, {67, -20}, {62, -20}}, color = {0, 0, 255}));
  connect(led_driver_3.pin_p, led_3.p) annotation(
    Line(points = {{130, -104}, {142, -104}, {142, -104}, {143, -104}, {143, -104}, {144, -104}}, color = {0, 0, 255}));
  connect(led_driver_3.pin_n, led_3.n) annotation(
    Line(points = {{130, -124}, {137, -124}, {137, -124}, {144, -124}, {144, -124}, {144, -124}}, color = {0, 0, 255}));
  connect(led_3.n, ground5.p) annotation(
    Line(points = {{144, -124}, {150, -124}, {150, -124}, {156, -124}, {156, -124}, {156, -124}, {156, -124}, {156, -124}, {156, -124}}, color = {0, 0, 255}));
  connect(led_driver_1.pin_p, led_1.p) annotation(
    Line(points = {{128, -10}, {140, -10}, {140, -10}, {140, -10}}, color = {0, 0, 255}));
  connect(led_driver_1.pin_n, led_1.n) annotation(
    Line(points = {{128, -30}, {134, -30}, {134, -30}, {140, -30}, {140, -30}, {140, -30}}, color = {0, 0, 255}));
  connect(ground4.p, led_1.n) annotation(
    Line(points = {{140, -34}, {140, -34}, {140, -30}, {140, -30}}, color = {0, 0, 255}));
  connect(led_driver_2.pin_p, led_2.p) annotation(
    Line(points = {{128, -56}, {140, -56}, {140, -56}, {140, -56}}, color = {0, 0, 255}));
  connect(led_driver_2.pin_n, led_2.n) annotation(
    Line(points = {{128, -76}, {140, -76}, {140, -76}, {140, -76}}, color = {0, 0, 255}));
  connect(ground7.p, led_2.n) annotation(
    Line(points = {{140, -80}, {140, -80}, {140, -76}, {140, -76}, {140, -76}, {140, -76}}, color = {0, 0, 255}));
  connect(led_driver_3.hPin_N, led_driver_2.hPin_N) annotation(
    Line(points = {{110, -124}, {102, -124}, {102, -76}, {108, -76}, {108, -76}}, color = {117, 80, 123}));
  ...
  connect(led_driver_2.hPin_P, z.pin_n) annotation(
    Line(points = {{108, -56}, {8, -56}, {8, 0}, {-6, 0}, {-6, 0}}));
  connect(led_driver_1.hPin_P, z.pin_n) annotation(
    Line(points = {{108, -10}, {88, -10}, {88, -56}, {8, -56}, {8, 0}, {-6, 0}, {-6, 0}}));
  connect(led_driver_3.hPin_P, z.pin_n) annotation(
    Line(points = {{110, -104}, {88, -104}, {88, -56}, {8, -56}, {8, 0}, {-6, 0}, {-6, 0}}));
  ...
  connect(led_driver_3.hPin_N, ground2.pin) annotation(
    Line(points = {{110, -124}, {20, -124}, {20, -40}, {-64, -40}, {-64, -40}}, color = {117, 80, 123}));
  annotation (
    ...
    Diagram(coordinateSystem(grid = {0, 0}, extent = {{-150, -150}, {150, 150}}, initialScale = 0.1), graphics = {Text(origin = {-126, 142}, extent = {{-20, 18}, {96, -20}}, textString = "DC-Testbed: Configuration 2
