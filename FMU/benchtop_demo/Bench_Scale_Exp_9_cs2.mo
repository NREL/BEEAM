model Bench_Scale_Exp_9_cs2
  ...
  Modelica.Blocks.Sources.Sine sine(amplitude=1000, freqHz=0.0001)
    annotation (Placement(transformation(extent={{134,28},{154,48}})));
  Modelica.Blocks.Sources.Ramp ramp(height=1000, duration=70000)
  ...
  in_cs2_fmu in_cs2_fmu1(fmi_StopTime=259200, fmi_NumberOfSteps=4320)
    annotation (Placement(transformation(extent={{168,46},{188,66}})));
equation
  ...
  connect(ConditionedZoneTotalLoss.y, y1) annotation (Line(points={{139,0},{146,
          0},{146,2},{160,2}}, color={0,0,127}));
  connect(in_cs2_fmu1.conditioned_zone_temp, ConditionedZoneAir.T) annotation (
      Line(points={{188,56},{194,56},{194,-80},{118,-80}}, color={0,0,127}));
  connect(sine.y, in_cs2_fmu1.conditioned_space_load) annotation (Line(points={
          {155,38},{158,38},{158,52.7},{167.6,52.7}}, color={0,0,127}));
  connect(ramp.y, in_cs2_fmu1.plenum_space_load) annotation (Line(points={{155,
          80},{160,80},{160,59.4},{167.6,59.4}}, color={0,0,127}));
  annotation (
