...
equation
  ...
  connect(ramp.y, 'in_fmu1'.plenum_space_load) annotation (Line(points={{155,80},
          {162,80},{162,49.4},{169.6,49.4}}, color={0,0,127}));
  connect(sine.y, 'in_fmu1'.conditioned_space_load) annotation (Line(points={{
          155,38},{162,38},{162,42.7},{169.6,42.7}}, color={0,0,127}));
  annotation (
