...
equation
  ...
  connect(rectifier1.pin_n, ground2.p) annotation(
    Line(points = {{6, -20}, {30, -20}}, color = {0, 0, 255}));
  ...
  connect(z.pin_n, rectifier1.hPin_P) annotation(
    Line(points = {{-20, 0}, {0, 0}}, color = {117, 80, 123}));
  ...
  connect(v.pin_n, rectifier1.hPin_N) annotation(
    Line(points = {{-60, -20}, {0, -20}}, color = {117, 80, 123}));
  connect(z.pin_n, rectifier1.hPin_P) annotation(
    Line(points = {{-20, 0}, {-14, 0}, {-14, 0}, {-14, 0}}, color = {117, 80, 123}));
  connect(rectifier1.hPin_N, v.pin_n) annotation(
    Line(points = {{-14, -20}, {-60, -20}, {-60, -20}, {-60, -20}}, color = {117, 80, 123}));
  connect(rectifier1.pin_n, ground2.p) annotation(
    Line(points = {{6, -20}, {30, -20}}, color = {0, 0, 255}));
  ...
  connect(rectifier1.pin_p, resistor1.p) annotation(
    Line(points = {{6, 0}, {50, 0}, {50, 0}, {50, 0}}, color = {0, 0, 255}));
