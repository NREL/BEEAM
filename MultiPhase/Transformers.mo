...
package Transformers
  ...
  HPF.SinglePhase.Interface.HPin_P hPin_P1 annotation(
      Placement(visible = true, transformation(origin = {-81, 41}, extent = {{-5, -5}, {5, 5}}, rotation = 0), iconTransformation(origin = {-81, 41}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  HPF.SinglePhase.Interface.HPin_P hPin_P2 annotation(
      Placement(visible = true, transformation(origin = {-81, 19}, extent = {{-5, -5}, {5, 5}}, rotation = 0), iconTransformation(origin = {-81, 19}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  HPF.SinglePhase.Interface.HPin_P hPin_P7 annotation(
      Placement(visible = true, transformation(origin = {80, -50}, extent = {{-4, -4}, {4, 4}}, rotation = 0), iconTransformation(origin = {80, -50}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  equation
  ...
  connect(hPin_P1, idealTransformer1.pinP_Prim) annotation(
      Line(points = {{-78, 24}, {-44, 24}, {-44, 60}, {-10, 60}, {-10, 60}}));
  ...
  connect(idealTransformer1.pinN_Sec, hPin_P7) annotation(
      Line(points = {{10, 40}, {52, 40}, {52, -38}, {52, -38}}, color = {117, 80, 123}));
  ...
  connect(idealTransformer2.pinN_Sec, hPin_P7) annotation(
      Line(points = {{10, 0}, {40, 0}, {40, -52}, {40, -52}}, color = {117, 80, 123}));
  connect(idealTransformer3.pinN_Sec, hPin_P7) annotation(
      Line(points = {{10, -40}, {40, -40}, {40, -52}, {40, -52}}, color = {117, 80, 123}));
    annotation (
