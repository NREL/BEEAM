...
package PhaseCoupling
  ...
  model PhaseSelect_P
    ...
    HPF.MultiPhase.Interface.MultiPhasePin_P multiPhasePin_P(systemDef.numPh) annotation(
    ...
    HPF.SinglePhase.Interface.HPin_P hPin_P(systemDef.numHrm) annotation(
