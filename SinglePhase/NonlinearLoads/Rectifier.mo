...
model Rectifier
  ...
  Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation (
    Placement(visible = true, transformation(origin = {78, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
/*
  ...
  */
  ...
  connect(constantVoltage1.n, pin_n) annotation (
    Line(points = {{34, -10}, {33, -10}, {33, -72}, {78, -72}}, color = {0, 0, 255}));
  /*
    -----------------------------------------------
    Power flow 
