...
model VoltageSrcLoadData "Harmonic Voltage Source (Load input data from a mat file)"
  /*
...
annotation (
  defaultComponentName = "v",
    Icon(coordinateSystem(grid = {0, 0}, extent = {{-200, -200}, {200, 200}}, initialScale = 0.1), graphics={  Ellipse(extent = {{-48, 50}, {48, -50}}, endAngle = 360), Line(origin = {-69, 0}, points = {{-21, 0}, {21, 0}}), Line(origin = {69, 0}, points = {{-21, 0}, {21, 0}}), Line(origin = {-8.2246, 18.6487}, points = {{8.50128, 21.0747}, {2.50128, 19.0747}, {-5.49872, 13.0747}, {-9.49872, 7.07465}, {-11.4987, -0.925349}, {-9.49872, -6.92535}, {-5.49872, -10.9253}, {0.501285, -14.9253}, {6.50128, -18.9253}, {8.50128, -18.9253}, {8.5013, -18.9253}}), Line(origin = {7.309, -18.9402}, rotation = 180, points = {{8.50128, 21.0747}, {2.50128, 19.0747}, {-5.49872, 13.0747}, {-9.49872, 7.07465}, {-11.4987, -0.925349}, {-9.49872, -6.92535}, {-5.49872, -10.9253}, {0.501285, -14.9253}, {6.50128, -18.9253}, {8.50128, -18.9253}, {8.5013, -18.9253}}), Text(origin = {-84, 47}, rotation = 90, extent = {{-14, 23}, {56, -19}}, textString = "%name"), Line(origin = {2.5156e-08, -70.7396}, rotation = 180, points = {{0, 10}, {0, -20}}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 15), Rectangle(origin = {2, -109}, extent = {{-30, 29}, {30, -29}}), Text(origin = {-7, -121}, rotation = 90, extent = {{-9, 17}, {33, -35}}, textString = "File", textStyle = {TextStyle.Bold})}),
