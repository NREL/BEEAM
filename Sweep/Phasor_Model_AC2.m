%% Phasor Model - AC Configuration 2
% Phasor-based model of CSU validation test AC Configuration 2, solved
...
%% Initialization
% Read test data:
data = importdata([data_dir 'combined-data-ac-config-2.csv']);
...
for i = idx
    ...
    for k = 1:10
        ...
        Ia = ...
            ...
            rectifier1P(hpElitebookAC, h, Va, P_hpElitebook(i)) + ...
            rectifier1P(hpPavilionAC, h, Va, P_hpPavilion(i)) + ...
            rectifier1P(ledDriver1AC, h, Va, P_led1(i)) + ...
            rectifier1P(ledDriver2AC, h, Va, P_led2(i)) + ...
            rectifier1P(ledDriver3AC, h, Va, P_led3(i));
...
% Issue: Phase A measurements (low-side) appear 180 deg. out-of-phase
