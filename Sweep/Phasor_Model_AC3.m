%% Phasor Model - AC Configuration 3
% Phasor-based model of CSU validation test AC Configuration 3, solved
...
%% Initialization
% Read test data:
data = importdata([data_dir 'combined-data-ac-config-3.csv']);
...
for i = idx
    ...
    for k = 1:10
        ...
        % Phase b: HP Envy laptop, HP Elitebook laptop, LED driver (2x)
        Ib = ...
            rectifier1P(hpEnvyAC, h, Vb, P_hpEnvy(i)) + ...
            rectifier1P(hpElitebookAC, h, Vb, P_hpElitebook(i)) + ...
            rectifier1P(ledDriver1AC, h, Vb, P_led1(i)) + ...
			rectifier1P(ledDriver2AC, h, Vb, P_led2(i));
        
        % Phase c: HP Pavilion laptop, LED driver (1x)
        Ic = ...
...
fname = [data_dir 'waveform-phase-b.csv'];
